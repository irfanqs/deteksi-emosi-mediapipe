...
export default function DashboardPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-50 to-slate-100 pt-32 pb-16 px-4">
      <div className="max-w-4xl mx-auto space-y-8">
        {/* Header Section */}
        <div className="text-center md:text-left flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            <h1 className="text-3xl font-extrabold text-slate-900 mb-1">Dasbor Wellness Anda 🌿</h1>
            <p className="text-slate-500">Pantau perkembangan dan jaga kesehatan mentalmu hari ini.</p>
          </div>
          <Link href="/" className="bg-gradient-to-r from-violet-600 to-fuchsia-600 text-white font-bold px-6 py-3 rounded-xl shadow-lg hover:shadow-xl hover:scale-105 transition-all w-full md:w-auto text-center">
            Pindai Wajah Baru
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="bg-slate-900 rounded-3xl p-6 shadow-md border border-slate-800 text-white relative overflow-hidden">
            <div className="absolute -right-10 -bottom-10 w-40 h-40 bg-fuchsia-600 rounded-full blur-3xl opacity-20 pointer-events-none" />
            <h3 className="text-lg font-bold flex items-center gap-2 mb-6">
              <span>🩺</span> Tracker SDKI / SIKI
            </h3>
            
            <div className="space-y-4 relative z-10">
              <div className="bg-slate-800/50 backdrop-blur-md p-5 rounded-2xl border border-slate-700/50 flex flex-col gap-2">
                <span className="text-xs font-bold text-fuchsia-400 uppercase tracking-widest">Klinis Info</span>
                <p className="text-sm text-slate-300 leading-relaxed">
                  Sistem sekarang akan mendata semua rekomendasi keperawatan berdasarkan SDKI persis ketika Anda memindai wajah.
                </p>
